...
CREATE TABLE `colonia` (
  ...
  `ciudadD` varchar(50) DEFAULT NULL,
  `asentamientoD` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idColonia`),
  KEY `colonia_ciudad_idx` (`idCiudad`),
  CONSTRAINT `colonia_ciudad` FOREIGN KEY (`idCiudad`) REFERENCES `ciudad` (`idCiudad`)
...
-- Dump completed on 2021-11-19 10:12:44
